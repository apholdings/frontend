          ...
          <div>
            <div>
              <h1 className="text-4xl font-semibold tracking-tight pb-16 ">
                Agencia de Software <span> </span>
                <Typewriter
                  words={['para Soñadores', 'para Creadores', 'para Emprededores', 'Para ti!']}
                  loop={0}
                  cursor
                  cursorStyle="_"
                  typeSpeed={120}
              ...
              <div className=" max-w-4xl leading-8 space-x-4">
                <span className=" text-md font-medium leading-8 dark:text-dark-txt-secondary text-black sm:text-center transition duration-300 ease-in-out border-b-2 border-transparent hover:border-orange-500">
                  <Link href="/services/blockchain_development">Blockchain</Link>
                </span>
                <span className=" text-md font-medium leading-8 dark:text-dark-txt-secondary text-black sm:text-center transition duration-300 ease-in-out border-b-2 border-transparent hover:border-orange-500">
                  <Link href="/services/backend_development">Microservicios</Link>
                </span>
                <span className=" text-md font-medium leading-8 dark:text-dark-txt-secondary text-black sm:text-center transition duration-300 ease-in-out border-b-2 border-transparent hover:border-orange-500">
                  <Link href="/services/web_development">Desarrollo Web</Link>
                </span>
                <span className=" text-md font-medium leading-8 dark:text-dark-txt-secondary text-black sm:text-center transition duration-300 ease-in-out border-b-2 border-transparent hover:border-orange-500">
                  <Link href="/services/software_development">Desarrollo de Software</Link>
                </span>
